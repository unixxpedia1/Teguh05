...
"
echo -e "\033[31m"
echo -e "\033[32mWHATSAPP : 085163622005\033[0m"
echo -e "\033[31mWEBSITE : https://t.me/Unixpublice"
echo ""

animate_text "ANDA SUDAH TERVERIFIKASI, SILAHKAN MASUKAN LICENSE YANG DI BAGI DARI Teguh50"
animate_text "JIKA BELUM PUNYA LICENSE SILAHKAN BELI DI Teguh50, UNTUK HARGA 30K FREE UPDATE LICENSE"
animate_text " CONTACT Teguh50: "
...
# Menampilkan opsi tanpa animasi
  ...
  echo -e "${BLUE}[+]            ©COPYRIGHT BY Teguh50      [+]${NC}"
  echo -e "${BLUE}[+]                                                [+]${NC}"
  echo -e "${BLUE}[+] ============================================== [+]${NC}"
echo ""
 echo -e "${BLUE}[+] ============================================== [+]${NC}"
